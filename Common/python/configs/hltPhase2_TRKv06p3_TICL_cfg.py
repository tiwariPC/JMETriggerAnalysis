...
from JMETriggerAnalysis.Common.customizeHLTForPhase2 import customise_hltPhase2_scheduleJMETriggers_TRKv06p3_TICL 

#call to customisation function customise_hltPhase2_scheduleJMETriggers_TRKv06p3_TICL imported from JMETriggerAnalysis.Common.customizeHLTForPhase2
process = customise_hltPhase2_scheduleJMETriggers_TRKv06p3_TICL(process)

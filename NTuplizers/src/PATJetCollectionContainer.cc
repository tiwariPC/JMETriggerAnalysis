...
PATJetCollectionContainer::PATJetCollectionContainer(const std::string& name, const std::string& inputTagLabel, const edm::EDGetToken& token)
...
void PATJetCollectionContainer::fill(const pat::JetCollection& coll, const bool clear_before_filling){

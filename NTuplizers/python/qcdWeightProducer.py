...
def qcdWeightProducer(BXFrequency, PU):
  ...
  print '>> WARNING -- getQCDWeightProducer(PU='+str(PU)+'): weight depends on hard-coded values of cross sections and #events of various MC samples (it will not be valid otherwise)'

...
class RecoPFClusterMETCollectionContainer : public VRecoCandidateCollectionContainer<reco::PFClusterMET> {
 ...
 public:
  explicit RecoPFClusterMETCollectionContainer(const std::string&, const std::string&, const edm::EDGetToken&, const std::string& strCut="", const bool orderByHighestPt=false);

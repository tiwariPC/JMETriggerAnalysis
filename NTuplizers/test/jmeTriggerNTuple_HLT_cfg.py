...
opts.register('reco', 'HLT_2018',
              vpo.VarParsing.multiplicity.singleton,
              vpo.VarParsing.varType.string,
              'keyword for reconstruction config')
...
###
if opts.reco == 'HLT_2018':
   from JMETriggerAnalysis.NTuplizers.frozen_2018_2e34_v3p6_HLT_V2_configDump import cms, process
else:
...
if opts.inputFiles:
   ...
   process.source.fileNames = [
     '/store/group/dpg_trigger/comm_trigger/TriggerStudiesGroup/Upgrade/Run2018D/EphemeralHLTPhysics/RAW/Run_323775/21FE6384-C3EC-0740-B44D-07090E86BDF1.root',
   ]

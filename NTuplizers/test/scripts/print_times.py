...
i_inptfile = ROOT.TFile.Open('DQM_V0001_R000000001__HLT__FastTimerService__All.root')
...
histo_nominal = i_inptfile.Get('DQMData/Run 1/HLT/Run summary/TimerService/process RECO2 paths/path HLT_PuppiMET200_v1/module_time_real_running')
print histo_nominal
#for hkey in histos:
if True:

...
config.General.requestName = 'jmeTriggerNTuple_Data_Run2018D_EGamma'
...
config.JobType.pyCfgParams = ['output=Data_Run2018D_EGamma.root']
...
config.Data.outLFNDirBase = '/store/user/missirol/jme_trigger/jmeTriggerNtuples/191021/Data_Run2018D_EGamma'
